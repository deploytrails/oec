...
const FacHandlingCourses = () => {
  ...
  const handleDownloadFacHandlingCourseReport=(e)=>{
    window.open("http://15.206.189.30:8081/faculty/getFacultyHandlingCoursesReport?employeeID=" + facId + "&departmentID=" + deptId+ "&facultyNo=" + facultyNo);
  }
  const handleDownloadAllFacHandlingCourseReport=()=>{
    window.open("http://15.206.189.30:8081/faculty/getAllFacultyHandlingCoursesReport?hodDepartmentID=" + deptId);     
  }
  return (
    <React.Fragment>
      <Layout>
