...
const NewRecordModal = ({ toggleModal,activeTab,activeTabData,FacultyId }) => {
    const modalDetailName=["Book Details","Book Details","Reference Link Details"]
    const newRecordButtonText=["Add Reference Book","Add Reference Book","Add Reference Link"]
