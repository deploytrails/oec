...
const ReferenceModelData = ({ activeTabData, FacultyId }) => {
    ...
    const tabDetailName=["Text Books & Authors","Reference Books","Exteranl Reference Links & Faculty Notes"]
    const newRecordText=["Text Book","Reference Book","Reference Links/Notes"]
    ...
    const loadReferenceData = async () => {
       const data = await getReferenceData(FacultyId,activeTabData[1].coursePrimaryId);
